...
import { BookOpen, Upload, LayoutDashboard, Search, Menu, X, Info, Home, LogIn, LogOut, User, ChevronDown, Sparkles, MessageSquareText } from 'lucide-react';
...
function Navbar() {
  ...
  const authLinks = [
    ...
    { path: '/search', label: 'AI Search', icon: MessageSquareText },
